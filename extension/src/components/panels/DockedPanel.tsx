 ...
 *
 * Deliberately omitted vs. the design reference: the "Clean session /
 * no paste, no tab switch" integrity block. There's no screen/tab-recording
 * signal behind it yet (Feature 12, still PLANNED) — showing it now would
 * be exactly the fabricated, not-evidence-based feedback CLAUDE.md §10
 * rules out. Also omitted: a "Hold to talk" push-to-talk button — mic
 * capture here runs continuously from session start (media/microphone.ts),
 * not per-press, so a hold-to-talk control would misrepresent what
 * actually happens. Ask-for-a-hint/Mute/End&review (below) are real.
 */
